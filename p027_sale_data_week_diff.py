...
date_sale = {}
is_first_line = True
with open("./datas/date_sales_data.txt", encoding="utf-8") as fin:
    for line in fin:
        if is_first_line:
            is_first_line = False
            continue
